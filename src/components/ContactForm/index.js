...
function ContactForm() {
  return (
    <div className="contact-form">
      ...
      <label className="contact-secondarytitle" htmlFor="nom-contact">Nom d'utilisateur</label>
      ...
      <label className="contact-secondarytitle" htmlFor="mail-contact">Adresse Mail</label>
      ...
      <label className="contact-secondarytitle" htmlFor="titre-contact">Titre du message</label>
      <input className="contact-form-input" placeholder="Titre du message" type="text" />
      <label className="contact-secondarytitle" htmlFor="message-contact">Message</label>
      <textarea
        rows="6"
